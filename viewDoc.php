...
if( empty( $_GET[ 'articleDate' ] ) ) {
    header( "Location: showarticle.php" );
    exit();
}

$startDate = mysql_real_escape_string( $_GET[ 'articleDate' ] );
$startDate = date( "Y-m-d" , strtotime( $startDate ) );

include( "onjon/DocByDate.php" );
$getDocByDate = new DocByDate( $startDate );
$getDocByDateRes = $getDocByDate -> getResult();
            ...
            <table class="datatable">
				...
				<tbody>
                    ...
                    if( $getDocByDateRes == 1 ) {
                        ...
                        $getTotalDocPerDay = $getDocByDate -> getTotal();
