...
<head>
	...
	<script type="text/javascript" src="auto/jquery.autocomplete.min.js"></script>
    <!-- <script type="text/javascript" src="auto/currency-autocomplete.js"></script> -->
    <!-- Get City Names -->
    <?php include( "auto/currency-autocomplete.php" ); ?>
    <!-- Get City Names End -->
