                ...
                ($.inArray('asc', oCol.asSorting) == -1 && $.inArray('desc', oCol.asSorting) == -1) )
      {
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input type="text" placeholder="search by anything" />') :
			  sSearchStr==="" ? '<input type="text"  placeholder="search by anything" />' : sSearchStr+' <input type="text"  placeholder="search by anything" />';
